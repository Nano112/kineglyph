...
const LAB_STYLES = `
.kg-lab{--kg-lab-border:var(--kg-shell-border,#d7dbe2);--kg-lab-bg:var(--kg-shell-background,#fff);--kg-lab-surface:var(--kg-shell-surface,#f7f8fa);--kg-lab-text:var(--kg-shell-text,#172033);--kg-lab-muted:var(--kg-shell-muted,#657087);--kg-lab-accent:var(--kg-shell-accent,#5b67f1);--kg-lab-code-bg:color-mix(in srgb,var(--kg-lab-bg) 92%,#0d1222);--kg-lab-code-text:var(--kg-lab-text);--kg-lab-font:var(--kg-shell-font,Inter,ui-sans-serif,system-ui,sans-serif);--kg-lab-mono:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,monospace;display:block;margin:1.5rem 0;overflow:hidden;border:1px solid var(--kg-lab-border);border-radius:12px;background:var(--kg-lab-bg);color:var(--kg-lab-text);font-family:var(--kg-lab-font)}
.kg-lab *{box-sizing:border-box}.kg-lab>[data-kg-static]{margin:0}.kg-lab__shell{display:block}.kg-lab__bar{display:flex;min-height:45px;align-items:center;justify-content:space-between;gap:12px;padding:6px 8px;border-bottom:1px solid var(--kg-lab-border);background:var(--kg-lab-surface)}
