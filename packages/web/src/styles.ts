...
.kg-figure__tooltip{position:absolute;z-index:7;left:0;top:0;width:max-content;max-width:min(280px,calc(100% - 16px));padding:10px 12px;border:1px solid color-mix(in srgb,var(--kg-shell-accent) 30%,var(--kg-shell-border));border-radius:8px;background:color-mix(in srgb,var(--kg-shell-surface) 94%,transparent);box-shadow:0 10px 28px color-mix(in srgb,#000 24%,transparent);color:var(--kg-shell-text);font:12px/1.4 var(--kg-shell-font);pointer-events:none;transform:translate(-50%,calc(-100% - 10px));backdrop-filter:blur(12px)}
.kg-figure__tooltip[hidden]{display:none}.kg-figure__tooltip[data-placement=below]{transform:translate(-50%,10px)}
.kg-figure__tooltip-role{display:block;margin-bottom:3px;color:var(--kg-shell-accent);font-size:9px;font-weight:750;letter-spacing:.13em;text-transform:uppercase}.kg-figure__tooltip strong{display:block;font-size:13px;line-height:1.25}.kg-figure__tooltip-summary{margin-top:4px;color:var(--kg-shell-muted)}.kg-figure__tooltip-fields{display:grid;grid-template-columns:auto auto;gap:2px 10px;margin:7px 0 0;font-size:11px}.kg-figure__tooltip-fields dt{color:var(--kg-shell-muted);font-weight:600}.kg-figure__tooltip-fields dd{margin:0;color:var(--kg-shell-text);font-variant-numeric:tabular-nums;text-align:right}
...
.kg-figure__machine-field{display:grid;grid-template-columns:auto minmax(96px,1fr);gap:4px 8px;align-items:center;color:var(--kg-shell-muted);font:650 10px/1.2 var(--kg-shell-font);letter-spacing:.04em}.kg-figure__machine-field--range{grid-template-columns:auto minmax(110px,1fr) 3.5ch}.kg-figure__machine-field output{color:var(--kg-shell-text);font-variant-numeric:tabular-nums;text-align:right}
.kg-figure__machine input[type=range]{width:100%;min-width:110px;accent-color:var(--kg-shell-accent)}.kg-figure__machine select{appearance:none;border:1px solid var(--kg-shell-border);border-radius:calc(var(--kg-shell-radius)/2);padding:7px 28px 7px 9px;background:var(--kg-shell-background);color:var(--kg-shell-text);font:600 12px/1 var(--kg-shell-font);background-image:linear-gradient(45deg,transparent 50%,var(--kg-shell-muted) 50%),linear-gradient(135deg,var(--kg-shell-muted) 50%,transparent 50%);background-position:calc(100% - 12px) 50%,calc(100% - 8px) 50%;background-size:4px 4px;background-repeat:no-repeat}.kg-figure__machine select:focus-visible,.kg-figure__machine input:focus-visible{outline:2px solid var(--kg-shell-accent);outline-offset:2px}
.kg-figure__machine-radio{display:flex;gap:4px}.kg-figure__machine-radio [role=radio][aria-checked=true]{border-color:var(--kg-shell-accent);background:color-mix(in srgb,var(--kg-shell-accent) 14%,var(--kg-shell-background))}
.kg-figure__machine-transport{display:flex;gap:4px}.kg-figure__machine-transport [data-transport-action=play][aria-pressed=true]{border-color:var(--kg-shell-accent);background:color-mix(in srgb,var(--kg-shell-accent) 14%,var(--kg-shell-background))}
...
.kg-doctor{position:absolute;inset:0;pointer-events:none;z-index:30}.kg-doctor__bounds{position:absolute;inset:0}.kg-doctor__box{position:absolute;border:1px solid #2477d4;background:#2477d410}.kg-doctor__box[data-severity=warning]{border-color:#d28617;background:#d2861714}.kg-doctor__box[data-severity=error]{border-color:#c73737;background:#c7373714}.kg-doctor__panel{position:absolute;top:8px;right:8px;width:min(360px,calc(100% - 16px));max-height:70%;overflow:auto;pointer-events:auto;border:1px solid var(--kg-shell-border);border-radius:8px;background:var(--kg-shell-background);color:var(--kg-shell-text);font:12px/1.35 var(--kg-shell-font);box-shadow:0 8px 24px #0002}.kg-doctor__panel summary{cursor:pointer;padding:8px 10px;font-weight:700}.kg-doctor__panel ol{display:grid;gap:8px;margin:0;padding:0 10px 10px 28px}.kg-doctor__panel li span,.kg-doctor__panel li small{display:block}.kg-doctor__panel li small{color:var(--kg-shell-muted)}
